      ...
      <div ref={ref} className="mx-auto flex max-w-[1120px] flex-col gap-14">
        ...
        >
          ...
          <p className="max-w-[680px] text-pretty font-body text-[16px] leading-[24px] tracking-[-0.32px] text-brimble-black/60">
            Set a sandbox up exactly how you want it — packages installed, files in place, env wired up — then freeze that moment. New
            sandboxes boot from the frozen state in seconds. Hand one to a teammate, roll one back when something breaks, or fan out a
            hundred copies that all start where the work began.
          </p>
        </motion.div>
