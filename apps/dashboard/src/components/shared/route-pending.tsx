...
function Block({ className = "" }: { className?: string }) {
  return <div className={`animate-pulse rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/40 ${className}`} />;
}
    ...
    <div className="max-w-[1000px]" aria-hidden="true">
      ...
      <div className="mb-8 flex flex-col overflow-hidden rounded border-[0.5px] border-dash-border lg:h-[160px] lg:flex-row">
        ...
        <div className="flex flex-1 flex-col border-t-[0.5px] border-dash-border lg:border-l-[0.5px] lg:border-t-0">
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-2 py-4 lg:py-0">
            ...
            <div className={`h-7 w-32 rounded-lg ${PULSE_BG_WEAK} animate-pulse`} />
          </div>
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="min-h-[168px] rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/30 animate-pulse" />
          ))}
        </div>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="min-h-[200px] rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/30 animate-pulse" />
          ))}
        </div>
      </div>
    </div>
    ...
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-6 py-8" aria-hidden="true">
      ...
      <div className="overflow-clip rounded-lg border-[0.5px] border-dash-border">
        <div className="relative h-[232px] overflow-clip bg-gradient-to-b from-dash-border-soft/60 to-dash-border-soft/30">
          <div className="absolute inset-x-[3.38%] top-[27px] h-[236px] overflow-clip rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/40">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex h-[68px] items-center border-b-[0.5px] border-dash-border px-3.5 last:border-b-0">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <div className={`size-[34px] rounded-lg border border-dash-border ${PULSE_BG_WEAK}`} />
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:gap-8">
        <div className="flex w-full flex-col gap-1.5 lg:w-[180px] lg:shrink-0">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className={`h-9 w-full animate-pulse rounded-lg ${PULSE_BG_WEAK}`} />
          ))}
        </div>
        <div className="min-w-0 flex-1 overflow-clip rounded-lg border-[0.5px] border-dash-border">
          <div className="flex flex-col gap-5 p-5">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex flex-col gap-2">
                <div className={`h-3.5 w-32 rounded ${PULSE_BG_MEDIUM} animate-pulse`} />
                <div className="h-10 w-full animate-pulse rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/40" />
              </div>
            ))}
            <div className="flex justify-end">
              <div className={`h-9 w-32 rounded-lg ${PULSE_BG_MEDIUM} animate-pulse`} />
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-6 py-8" aria-hidden="true">
      ...
      <div className="flex flex-col gap-2.5 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
        <div className="h-9 flex-1 animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30 sm:min-w-[280px]" />
        <div className="h-9 w-[180px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
        <div className="h-9 w-[140px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
        <div className="h-9 w-[120px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
      </div>
      <div className="overflow-clip rounded-lg border-[0.5px] border-dash-border">
    ...
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-4 py-8" aria-hidden="true">
      ...
      <div className="overflow-clip rounded-lg border-[0.5px] border-dash-border">
        <div className="flex items-center justify-between border-b-[0.5px] border-dash-border px-3.5 py-3.5">
          <div className="h-9 max-w-[280px] flex-1 animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
          <div className={`h-9 w-32 rounded-lg ${PULSE_BG_MEDIUM} animate-pulse`} />
        </div>
...
export function ProjectDomainsPending() {
  return (
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-6 py-8" aria-hidden="true">
      ...
      <div className="h-9 max-w-[320px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
      <div className="overflow-clip rounded-lg border-[0.5px] border-dash-border">
        {Array.from({ length: 5 }).map((_, i) => (
  ...
  return (
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-4 py-8" aria-hidden="true">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="h-9 flex-1 min-w-[220px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
        <div className="h-9 w-[160px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
        <div className="h-9 w-[140px] animate-pulse rounded-lg border border-dash-border bg-dash-bg-elevated/30" />
      </div>
      <div className="rounded-lg border-[0.5px] border-dash-border bg-[#0c0c0e] p-3">
    ...
    <div className="mx-auto flex w-full max-w-[1000px] flex-col gap-6 py-8" aria-hidden="true">
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="flex flex-1 flex-col gap-3 rounded-lg border-[0.5px] border-dash-border p-5">
  ...
  return (
    <div className="mx-auto w-full max-w-[680px] py-8" aria-hidden="true">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex min-h-[132px] flex-col gap-3 rounded-lg border-[0.5px] border-dash-border p-5">
  ...
  return (
    <div className="mx-auto w-full max-w-[1000px] py-8" aria-hidden="true">
      ...
      <div className="mb-5 flex items-center gap-3">
        <div className="h-10 min-w-0 flex-1 rounded-lg border-[0.5px] border-dash-border bg-dash-bg-elevated/30 animate-pulse" />
